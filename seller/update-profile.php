...
header('location:../index.php');
  ...
  // Update user
	if (isset($_POST['update-btn'])) {
  	...
  	$update_query = mysqli_query($conn, "UPDATE seller SET name='$name', contact='$contact', address='$address', state='$state', city='$city', zip='$zip' WHERE id=$sid");
  	if ($update_query) {
  ...
  // display details
  $query3 = "SELECT * FROM seller WHERE id='$sid'";
