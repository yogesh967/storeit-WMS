...
<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group list-group-flush">
    ...
    <a href="view-order.php" class="list-group-item list-group-item-action bg-light">Orders</a>
    <a href="order-status.php" class="list-group-item list-group-item-action bg-light">View order status</a>
